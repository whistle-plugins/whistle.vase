...
var Index = React.createClass({
	...
	render: function() {
		...
		var engineName;
		if (activeItem) {
			engineName = <span className="w-engine-name">Engine(<a href={'https://github.com/avwo/vase#' + activeItem.type.toLowerCase()} target="_blank">{activeItem.type}</a>)</span>;
		}
		...
		return (<div className="container orient-vertical-box">
					<div className="w-menu">
						...
						<a className="w-help-menu" href="https://github.com/avwo/vase#vase" target="_blank"><span className="glyphicon glyphicon-question-sign"></span>Help</a>
						{engineName}
					</div>
						...
						<div className="modal-dialog"> 
						      ...
						      <ul className="modal-body">
						      	 ...
						      	 <li className="w-template-type">
					      	 		...
					      	 		})}<a title="Help" className="glyphicon glyphicon-question-sign w-vase-help" href="https://github.com/avwo/vase#vase" target="_blank"></a>
						      	 </li>
						      </ul>
